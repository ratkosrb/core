...
ChatCommand * ChatHandler::getCommandTable()
{
    ...
    static ChatCommand commandTable[] =
    {
        ...
        { NODE, "spawndelete",            SEC_GAMEMASTER,     false, &ChatHandler::HandleSpawnDeleteCommand,                 "", nullptr },
        { NODE, "spawnupdate",            SEC_GAMEMASTER,     false, &ChatHandler::HandleSpawnUpdateCommand,                 "", nullptr },
        { NODE, "spawngo",            SEC_GAMEMASTER,     false, &ChatHandler::HandleSpawnGoCommand,                 "", nullptr },
        { NODE, "spawnpool",            SEC_GAMEMASTER,     false, &ChatHandler::HandleSpawnPoolCommand,                 "", nullptr },
        { NODE, "spawnok",            SEC_GAMEMASTER,     false, &ChatHandler::HandleSpawnOkCommand,                 "", nullptr },
        { NODE, "spawnentry",            SEC_GAMEMASTER,     false, &ChatHandler::HandleSpawnEntryCommand,                 "", nullptr },
        { NODE, "spawnmove",            SEC_GAMEMASTER,     false, &ChatHandler::HandleSpawnMoveCommand,                 "", nullptr },
