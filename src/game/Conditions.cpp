    ...
    switch (m_condition)
    {
        ...
        case CONDITION_AD_COMMISSION_AURA:
        {
            ...
            for (const auto& aura : auras)
                if ((aura.second.aura->GetSpellProto()->Attributes & SPELL_ATTR_CASTABLE_WHILE_MOUNTED || aura.second.aura->GetSpellProto()->Attributes & SPELL_ATTR_IS_ABILITY) && aura.second.aura->GetSpellProto()->SpellVisual == 3580)
                    return true;
            return false;
        }
