...
{
    sLog.outInfo("Condition-System: Check condition %u, type %i - called from %s with params target: %s, map %i, source %s",
    ...
    sLog.outInfo("Condition-System: condition %u result %u", m_entry, result);
    return result;
}
