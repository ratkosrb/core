...
public:
    ...
    void WriteEnum(google::protobuf::EnumValueDescriptor const* value) { _writer.String(value->name().c_str()); }
    void WriteString(std::string const& value) { _writer.String(value.c_str()); }
