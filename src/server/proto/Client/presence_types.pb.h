...
class RichPresenceLocalizationKey : public ::google::protobuf::Message {
 public:
 ...
 private:
  ...
  friend void protobuf_AddDesc_presence_5ftypes_2eproto();
...
class PresenceState : public ::google::protobuf::Message {
 public:
  PresenceState();
