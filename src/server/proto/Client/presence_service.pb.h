...
class BatchSubscribeRequest : public ::google::protobuf::Message {
 public:
...
class SubscribeResult : public ::google::protobuf::Message {
 public:
  SubscribeResult();
...
class BatchSubscribeResponse : public ::google::protobuf::Message {
 public:
...
class BatchUnsubscribeRequest : public ::google::protobuf::Message {
 public:
