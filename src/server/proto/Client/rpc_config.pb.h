...
class RPCMethodConfig : public ::google::protobuf::Message {
 public:
  RPCMethodConfig();
 ...
 private:
  ...
  friend void protobuf_AddDesc_rpc_5fconfig_2eproto();
...
class RPCMeterConfig : public ::google::protobuf::Message {
 public:
  RPCMeterConfig();
...
class ProtocolAlias : public ::google::protobuf::Message {
 public:
  ProtocolAlias();
...
class ServiceAliases : public ::google::protobuf::Message {
 public:
  ServiceAliases();
