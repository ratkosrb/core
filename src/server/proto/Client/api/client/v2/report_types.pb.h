...
class ReportItem : public ::google::protobuf::Message {
 public:
  ReportItem();
  virtual ~ReportItem();
 ...
 private:
  ...
  friend void protobuf_AddDesc_api_2fclient_2fv2_2freport_5ftypes_2eproto();
...
class UserOptions : public ::google::protobuf::Message {
 public:
  UserOptions();
  virtual ~UserOptions();
...
class ClubOptions : public ::google::protobuf::Message {
 public:
  ClubOptions();
  virtual ~ClubOptions();
