...
class GetEventOptions : public ::google::protobuf::Message {
 public:
  GetEventOptions();
 ...
 private:
  ...
  int order_;
  friend void protobuf_AddDesc_event_5fview_5ftypes_2eproto();
...
class ViewMarker : public ::google::protobuf::Message {
 public:
  ViewMarker();
  virtual ~ViewMarker();
