...
class EmbedImage : public ::google::protobuf::Message {
 public:
  EmbedImage();
  virtual ~EmbedImage();
 ...
 private:
  ...
  friend void protobuf_AddDesc_embed_5ftypes_2eproto();
...
class Provider : public ::google::protobuf::Message {
 public:
  Provider();
  virtual ~Provider();
...
class EmbedInfo : public ::google::protobuf::Message {
 public:
  EmbedInfo();
  virtual ~EmbedInfo();
