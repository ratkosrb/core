...
class ResolveAccountRequest : public ::google::protobuf::Message {
 public:
...
class ResolveAccountResponse : public ::google::protobuf::Message {
 public:
...
class GetSignedAccountStateRequest : public ::google::protobuf::Message {
 public:
...
class GetSignedAccountStateResponse : public ::google::protobuf::Message {
 public:
