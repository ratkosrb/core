...
class ClubMembershipDescription : public ::google::protobuf::Message {
 public:
 ...
 private:
  ...
  friend void protobuf_AddDesc_club_5fmembership_5ftypes_2eproto();
...
class ClubMembershipState : public ::google::protobuf::Message {
 public:
  ClubMembershipState();
...
class ClubPosition : public ::google::protobuf::Message {
 public:
  ClubPosition();
...
class ClubSharedSettings : public ::google::protobuf::Message {
 public:
  ClubSharedSettings();
...
class ClubSharedSettingsOptions : public ::google::protobuf::Message {
 public:
...
class ClubSharedSettingsAssignment : public ::google::protobuf::Message {
 public:
