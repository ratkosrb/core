...
class SubscribeRequest : public ::google::protobuf::Message {
 ...
 private:
  ...
  friend void protobuf_AddDesc_club_5fmembership_5fservice_2eproto();
...
class GetStateRequest : public ::google::protobuf::Message {
 public:
  GetStateRequest();
...
class GetStateResponse : public ::google::protobuf::Message {
 public:
  GetStateResponse();
...
class UpdateClubSharedSettingsRequest : public ::google::protobuf::Message {
 public:
...
class GetStreamMentionsRequest : public ::google::protobuf::Message {
 public:
...
class GetStreamMentionsResponse : public ::google::protobuf::Message {
 public:
...
class RemoveStreamMentionsRequest : public ::google::protobuf::Message {
 public:
...
class ClubMembershipService : public ServiceBase
{
 public:
