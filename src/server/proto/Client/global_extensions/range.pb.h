...
class UnsignedIntRange : public ::google::protobuf::Message {
 public:
  UnsignedIntRange();
 ...
 private:
  ...
  friend void protobuf_AddDesc_global_5fextensions_2frange_2eproto();
...
class SignedIntRange : public ::google::protobuf::Message {
 public:
  SignedIntRange();
...
class FloatRange : public ::google::protobuf::Message {
 public:
  FloatRange();
  virtual ~FloatRange();
