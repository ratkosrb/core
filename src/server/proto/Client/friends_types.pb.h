...
class ReceivedInvitation : public ::google::protobuf::Message {
 public:
  ReceivedInvitation();
...
class SentInvitation : public ::google::protobuf::Message {
 public:
  SentInvitation();
...
class AcceptInvitationOptions : public ::google::protobuf::Message {
 public:
