...
class ClubPrivilegeSet : public ::google::protobuf::Message {
 public:
  ClubPrivilegeSet();
 ...
 private:
  ...
  friend void protobuf_AddDesc_club_5frole_2eproto();
...
class ClubRole : public ::google::protobuf::Message {
 public:
  ClubRole();
  virtual ~ClubRole();
...
class ClubRoleSet : public ::google::protobuf::Message {
 public:
  ClubRoleSet();
  virtual ~ClubRoleSet();
